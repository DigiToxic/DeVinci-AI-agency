...
function page4() {
  return (
    <div className="h-screen flex justify-between items-center mt-10 max-[850px]:h-full">
      <div className="ml-10 mb-28">
      ...
      <img className="w-[700px] max-[1265px]:w-1/2 max-[850px]:hidden" src="/happy.png" alt="" />
    </div>
  );
}
